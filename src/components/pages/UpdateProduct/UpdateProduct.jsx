...
const UpdateProduct = () => {
    ...
    return (
        <div className="bg-[#F4F3F0] p-5">
            <h2 className="text-4xl text-[#374151] text-center font-bold font-[Rancho] my-10">Update Product</h2>
            <form onSubmit={handleUpdateProduct}>
                ...
                <div className="mb-10 form-control w-1/2">
                    ...
                    <label className="input-group">
                        <input type="text" name="rating" id="rating" defaultValue={rating} placeholder="Enter a number from 1 to 5" className="input input-bordered w-full" />

                    </label>
                </div>

                <input className="btn btn-error w-full text-white  normal-case font-bold text-xl" type="submit" value="Update Product" />
